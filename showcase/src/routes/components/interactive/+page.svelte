<script lang="ts">
  ...
  const activationMultipliers = [0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 8, 10, 15, 20, 30, 50, 100];
  ...
  const audienceStore = {
    ...
    setAudience(v: Audience) { audience = v; }
  };
...
<div class="showcase-page">
  ...
  <div>
    <ShowcaseSection id="accordion" title="Accordion">
      ...
      <pre><code>{`<Accordion title="What is photosynthesis?">
  <p>Content…</p>
</Accordion>
<Accordion title="Open by default" open>
  <p>Content…</p>
    ...
    <ShowcaseSection id="accordion2" title="Accordion2">
      ...
      <div class="preview">
        <Accordion2 bind:open={accordion2Open}>
          ...
          <p style="padding: var(--space-4) 0 0">
            Unlike <code>Accordion</code>, this variant accepts a full snippet as
            its header — useful for icons, badges, or complex trigger layouts.
          </p>
        </Accordion2>
      </div>
      <pre><code>{`<Accordion2 bind:open>
  {#snippet header()}
    <Icon>settings</Icon>
    <strong>Advanced settings</strong>
  {/snippet}
  <p>Hidden content…</p>
    ...
    <ShowcaseSection id="popover" title="Popover">
      <h3>Native popover API panel — anchored to a trigger button</h3>
      <div class="preview">
        <Row align="center" gap="var(--space-3)">
          <ButtonIcon icon="info" popovertarget="demo-popover" />
          <Text color="secondary">Click the icon to open the popover</Text>
        </Row>
        <Popover size="sm" popovertarget="demo-popover">
          <p><strong>About this model</strong></p>
          <p>This panel appears anchored to the trigger button using the native Popover API.</p>
        </Popover>
      </div>
      <pre><code>{`<ButtonIcon icon="info" popovertarget="my-popover" />
<Popover size="sm" popovertarget="my-popover">
  <p>Popover content</p>
</Popover>
<!-- size: "xs" | "sm" | "md" | "lg" -->`}</code></pre>
    </ShowcaseSection>

    <ShowcaseSection id="slider" title="Slider">
      <h3>Labeled range input with live value display</h3>
      <div class="preview">
        <Slider name="Light intensity" desc="μmol/m²/s" bind:value={sliderVal} min={0} max={200} step={1} />
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="slider2" title="Slider2">
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="slideractivation" title="SliderActivation">
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="toggleaudience" title="ToggleAudience">
      <h3>Segmented button toggle for audience selection</h3>
      <div class="preview">
        <AudienceToggle {audienceStore} options={audienceOptions} />
        <p class="demo-label">Selected: {audience}</p>
      </div>
      <pre><code>{`<!-- Create a store with audience state -->
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="togglelanguage" title="ToggleLanguage">
      ...
      <div class="preview note">
        <Text color="secondary">
          ...
          and requires the paraglide-js adapter to be configured in the consuming site.
        </Text>
      </div>
      <pre><code>{`<!-- Requires @inlang/paraglide-js in the consuming site -->
<ToggleLanguage
  locales={[
    { code: "en", label: "EN" },
    { code: "de", label: "DE" },
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="videotranscripttoggle" title="VideoTranscriptToggle">
      ...
      <pre><code>{`<VideoTranscriptToggle
  message="Show transcript"
