...
<div class="showcase-page">
  ...
  <div>
    <ShowcaseSection id="navbar" title="Navbar + NavItem">
  ...
  <NavItem href="/publications">Publications</NavItem>
    ...
    <ShowcaseSection id="navgh" title="NavGH">
  ...
  <NavGH href="https://github.com/your-org" />
    ...
    <ShowcaseSection id="sidebar" title="Sidebar">
      <h3>Left navigation — collapses to hamburger below 768px</h3>
      <div class="preview" style="padding: 0; overflow: hidden; height: 200px; display: flex">
        <Sidebar>
          <a href="/" class="active" aria-current="page">Introduction</a>
          <a href="/photosynthesis">Photosynthesis</a>
          <a href="/method">Method</a>
          <a href="/model">Model</a>
          <a href="/experiments">Experiments</a>
        </Sidebar>
        <div style="padding: var(--space-4); color: var(--color-text-muted); font-size: 0.875rem;">
  ...
  <a href="/model">Model</a>
    ...
    <ShowcaseSection id="sidebar2" title="Sidebar2">
      ...
      <div class="preview note">
        <Text color="secondary">
          ...
          <code>audienceStore</code>, and <code>audienceOptions</code> props.
          It is site-specific to comphot.
        </Text>
      </div>
      <pre><code>{`<Sidebar2
  navLinks={[
...
/>`}</code></pre>
    ...
    <ShowcaseSection id="pagenav" title="PageNav">
...
<PageNav {base} prev={…} next={…} />`}</code></pre>
    </ShowcaseSection>
